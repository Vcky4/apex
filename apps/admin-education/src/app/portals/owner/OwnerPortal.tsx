...
export default function OwnerPortal({ user, onLogout }: OwnerPortalProps) {
  ...
  const navigation = [
    ...
    },
    {
      ...
      onClick: () => navigate('/admin/principal/dashboard'),
    },
    {
    ...
    },
    {
      ...
      icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4" /></svg>,
      onClick: () => navigate('/admin/department/science/dashboard'),
    },
    {
      label: 'Student Affairs',
      href: '/admin/vice-principal/student-affairs/dashboard',
      icon: <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z" /></svg>,
      onClick: () => navigate('/admin/vice-principal/student-affairs/dashboard'),
    },
  ];
  ...
  return (
    <AdminLayout
      ...
      userMenu={userMenu}
      vertical="education"
      sidebarColor="bg-executive-gold"
    >
      <Routes>
